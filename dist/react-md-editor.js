...
var MarkdownEditor = React.createClass({
	...
	renderButton: function renderButton(formatKey, label, action) {
		...
		return React.createElement(
			'button',
			{ className: className, onClick: action, title: formatKey, type: buttonType },
...
},{"./format.js":7,"./icons":10,"classnames":undefined,"codemirror":2,"codemirror/addon/edit/continuelist":1,"codemirror/mode/markdown/markdown":3,"codemirror/mode/xml/xml":5}],7:[function(require,module,exports){
'use strict';
